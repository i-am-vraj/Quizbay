...
import com.example.quizbay.builder.IApiInterface;
import com.example.quizbay.builder.RetrofitBuilderCommon;
import com.example.quizbay.model.DecodedJWTEntity;
                        ...
                        public void onResponse(Call<UserRegisterResponse> call, Response<UserRegisterResponse> response) {
                            ...
                            try {
                                ...
                                if(decodedJWTEntity.getUserId() != null) {
                                    Call<ResponseBody> apiCallAppendNotification = iApiInterface.appendNotification(channelId, decodedJWTEntity.getUserId(), notificationToken);
